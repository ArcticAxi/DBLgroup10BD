    ...
    getMeta(content, name,
        ...
        function (width, height, hasImage) {
            ...
            if (hasImage) {
                ...
                heatmapCanvas.style.backgroundImage = stimuliLocationURL;
            ...
            heatmapCanvas.style.backgroundSize = background_size;

            heatmapCanvas.style.width = "'" + sizeWidth + "'";
            heatmapCanvas.style.height = "'" + sizeHeight + "'";
